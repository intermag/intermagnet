...
class IntermagWorker():
	...
	def __init__(self):
		...
		result = channel.queue_declare(queue='intermagnet_task_queue', durable=True)
	...
	def un_zip(self, file_path, file_name):
		#eg: file_path='/home/undoingfish/Documents/zip_temp/data20170404052351.zip'  file_name='data20170404052351.zip'
		file_read_path = ''
		...
		if os.path.isdir(file_path[:-4]+'/'): #判断文件夹是否已经存在
			...
			#eg: save_name='/home/undoingfish/Documents/zip_temp/data20170404052351.zip'
			print save_name
		...
		for names in zip_file.namelist():
			...
			if names[-3:]=='.gz':
				...
				#eg: file_path='/home/undoingfish/Documents/zip_temp/data20170404052351.zip'  names='cbb20160101vmin.min.gz'
			if names[-4:]=='.sec':
	...
	def un_gz(self, file_path, file_name):
		#eg: file_path='/home/undoingfish/Documents/zip_temp/data20170404052351.zip'  file_name='cbb20160101vmin.min.gz'
		save_path = file_path[:-4]+'/'+file_name
		#eg: save_path='/home/undoingfish/Documents/zip_temp/data20170404052351/cbb20160101vmin.min.gz'
		f_name = save_path.replace(".gz", "")
		#eg: save_path='/home/undoingfish/Documents/zip_temp/data20170404052351/cbb20160101vmin.min'
	...
	def first_decompress(self, path, filename):
		...
		#eg: path='/home/undoingfish/Documents/zip_temp/data20170404052351.zip'  file_name='data20170404052351.zip'
		print path
	...
	def fetch_out(self, res):
		...
		#eg: save_path = '/home/undoingfish/Documents/zip_temp/data20170404052351.zip'
